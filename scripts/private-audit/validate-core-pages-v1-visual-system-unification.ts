...
const BASE_URL = process.env.CORE_PAGES_V1_VISUAL_AUDIT_BASE_URL ?? "http://localhost:3000";
const CHROME_PATH = "/Applications/Google Chrome.app/Contents/MacOS/Google Chrome";
const screenshotDir = fs.mkdtempSync(path.join(os.tmpdir(), "airburg-core-pages-v1-visual-system-"));
...
const sourceChecks = () => {
  ...
  const requiredSourceChecks = {
    ...
    lightCardBorders: !allSources.includes("border-2 border-slate-900") && !allSources.includes("bg-[#141923]"),
