...
const validateWithMemoryRepository = async (
  ...
  const insertResults = await Promise.all([
    ...
    repository.afterSalesOperationalSnapshots.insertMany(stagingDataset.afterSalesOperationalSnapshots),
    repository.afterSalesDistributionItems.insertMany(stagingDataset.afterSalesDistributionItems),
...
export const runLegacyStorageV2DryRunMigration = async (
  ...
  const stagingDataset: V2StagingDataset = {
    ...
    afterSalesOperationalSnapshots: analysis.afterSalesOperationalSnapshots,
    afterSalesDistributionItems: analysis.afterSalesDistributionItems,
