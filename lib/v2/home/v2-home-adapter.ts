...
export const V2_HOME_CHART_PAIRS: V2HomeChartPair[] = [
  ...
  {
    id: "paid-buyers-visitors",
    label: "支付买家数 vs 访客数",
    leftMetricKey: "paidBuyers",
    rightMetricKey: "visitors",
    leftLabel: "支付买家数",
    rightLabel: "访客数",
    leftUnit: "人",
    rightUnit: "人",
  ...
  {
    id: "spend-rate-refund-rate",
    label: "去退费比 vs 退货率",
    leftMetricKey: "adSpendRateAfterRefund",
    rightMetricKey: "refundRate",
    leftLabel: "去退费比",
    rightLabel: "退货率",
    leftUnit: "%",
    rightUnit: "%",
  ...
  {
    id: "direct-share-conversion-rate",
    label: "直接成交占比 vs 转化率",
    leftMetricKey: "directTransactionShare",
    rightMetricKey: "conversionRate",
    leftLabel: "直接成交占比",
    rightLabel: "转化率",
    leftUnit: "%",
    rightUnit: "%",
  ...
  {
    id: "signed-shipped-refund-rates",
    label: "已签收退货率 vs 发货退货率",
    leftMetricKey: "signedRefundRate",
    rightMetricKey: "shippedRefundRate",
    leftLabel: "已签收退货率",
    rightLabel: "发货退货率",
    leftUnit: "%",
    rightUnit: "%",
  ...
  {
    id: "brand-buyers-visitors",
    label: "品牌词支付人数 vs 品牌词访客",
    leftMetricKey: "brandPaidBuyers",
    rightMetricKey: "brandVisitors",
    leftLabel: "品牌词支付人数",
    rightLabel: "品牌词访客",
    leftUnit: "人",
    rightUnit: "人",
  ...
  {
    id: "average-order-value-gmv",
    label: "客单价 vs GMV",
    leftMetricKey: "averageOrderValue",
    rightMetricKey: "gmv",
    leftLabel: "客单价",
    rightLabel: "GMV",
    leftUnit: "元",
  ...
  {
    id: "conversion-rate-direct-share",
    label: "转化率 vs 直接成交占比",
    leftMetricKey: "conversionRate",
    rightMetricKey: "directTransactionShare",
    leftLabel: "转化率",
    rightLabel: "直接成交占比",
    leftUnit: "%",
    rightUnit: "%",
