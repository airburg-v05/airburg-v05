...
import type { TmallSeriesMetric } from "@/lib/tmall/view-models/series-board";
import { formatMetricValue } from "./series-format";

interface SeriesMetricGridProps {
  title: string;
  description: string;
  metrics: TmallSeriesMetric[];
  emptyMessage?: string;
  notice?: string;
}

export function SeriesMetricGrid({
  title,
  description,
  metrics,
  emptyMessage,
  notice,
}: SeriesMetricGridProps) {
  return (
